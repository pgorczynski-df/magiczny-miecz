 ...
 */
    ...
    let threeXWindowResize = function (renderer, camera) {
    ...
    var lesson10 = {
      ...
      init: function () {
        ...
        // Events
        threeXWindowResize(this.renderer, this.camera);
      ...
      onDocumentMouseDown: function (event) {
        ...
        if (intersects.length > 0) {
          ...
          var intersects2 = lesson10.raycaster.intersectObject(lesson10.plane);

          lesson10.offset.copy(intersects2[0].point).sub(lesson10.plane.position);
        }
      },
